...
@interface HSYuyinViewController ()

@end

@implementation HSYuyinViewController
...
- (void)viewDidLoad
{
    ...
    NSString *strTil =[NSString stringWithFormat:@"%d年语音知识",[hsTiku year]];
    self.title = strTil;
...
-(NSString *)changed:(NSString *)sender
{
    [sender stringByReplacingOccurrencesOfString:@"&lt;U&gt;" withString:@"\\&gt;U&gt;"];
    return sender;
}
