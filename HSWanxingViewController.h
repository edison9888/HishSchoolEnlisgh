...
@interface HSWanxingViewController : UIViewController<UIScrollViewDelegate>
{
    HSTiku  * hsTiku;
    NSArray * hsArray;
    ...
    int titleNum;//当前题数
    int row;
    UIButton *nextTitleBtn;//下一题按钮
    
    UIImageView *imgView;//背景图片
    UIButton * tanchuBtn;
    int xuanxiangSwitch;
    UIImageView *imageView;
    UITextView *answerList;//答案列表页
    
}
@property (nonatomic,strong)UITextView *answerList;
@property (nonatomic,strong)UIImageView *imageView;
@property int xuanxiangSwitch;
@property (nonatomic,strong)UIButton * tanchuBtn;
